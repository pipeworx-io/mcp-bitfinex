...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/bitfinex_tickers \
  -H 'Content-Type: application/json' \
  -d '{"symbols":"tBTCUSD,tETHUSD"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/bitfinex_tickers`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
